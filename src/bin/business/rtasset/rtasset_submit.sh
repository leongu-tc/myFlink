...
#  --class "leongu.myflink._business.rt_asset.RTAsset" \
#  --master yarn \
#  --deploy-mode cluster \
#  --driver-memory 1g \
#  --executor-memory 2g \
...
#  --queue root \
#  /data/gulele/spark/myflink-1.0.0-jar-with-dependencies.jar \
#  rtasset.yaml
...
spark-submit \
 ...
 --executor-memory 1g \
 --executor-cores 1 \
 --files /Users/apple/workspaces/github/_my/myflink/bin/business/rtasset/mac.yaml \
 --queue root \
 /Users/apple/workspaces/github/_my/myflink/target/myflink-1.0.0-jar-with-dependencies.jar \
 mac.yaml
